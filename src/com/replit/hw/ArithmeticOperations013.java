...
public class ArithmeticOperations013 {
	public static void main(String[] args) {
		/*
		 * In this project, you will become a magician and write a small program that
		 * performs a mathematical magic trick! It will involve performing arithmetic
		 * operations on an integer that you created.
		 * 
		 * For you to do:
		 * 
